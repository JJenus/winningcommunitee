					...
					<div class="row">
						<div class="col-12 mb-3 col-12 text-light">
							...
							<p class="mt-4 text-warning">
								You're adviced to pick only the best and
								maximize your stake, but to get
								<strong
									><em
										>more accurate picks, please contact the
										experts.</em
									></strong
								>
							</p>
						...
						<div class="col-12 order-md-last mb-3 col-12">
							<div class="card mx-n3 mx-md-0">
								<div class="card-body px-0 px-md-4">
									...
									<div class="table-responsive pb-3">
										<table
											class="table table-sm text-nowrap mb-0"
										>
											<thead class="">
												<tr
